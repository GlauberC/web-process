const configVizuHelper = require('../src/helpers/configVizualizationHelper')
const chai = require('chai')
const expect = chai.expect


describe('Config Vizualization', () => {

    it(`Config Vizualization helper: only Tells`, done => {
        ...
        const functionResult = configVizuHelper.getConfigVizualization(process, constraints, redex)
        expect(functionResult).be.equal(configResult)

        done()
    })

    it(`Config Vizualization helper:  Tell and Ask`, done => {
    ...
    it(`Config Vizualization helper:  Tell and many Asks`, done => {
    ...
    it(`Config Vizualization helper:  sum`, done => {
      let process = "ask 'd then tell('c) && ask 'a then tell('g) && ask 'd then tell('h)"
      let constraints = "'d"
      let redex = 
      [
        {
