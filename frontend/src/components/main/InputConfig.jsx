...
export default props => {
    ...
    return <div className = "mt-4">
        ...
        <div className="form-group mt-4">
            ...
            <textarea className="form-control textInput" rows="5" id="comment" placeholder = "Definition ; Process ; Constraints" defaultValue = "def( 'defname, tell('a) ) ; call('defname) || tell( 'b ) || (( ask 'c then tell ('d) ) + ( ask 'c then tell ('e)) + ( ask 'b then tell ('e)) ) ; 'c"></textarea>
